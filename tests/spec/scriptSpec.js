...
describe('fixNumber function', function () {
    ...
    describe('display Error', function () {
        ...
        describe('positive decimal numbers on 9 characters', function () {
        ...
        describe('positive decimal numbers on 10 characters', function () {
        ...
        describe('negative decimal numbers on 9 characters', function () {
        ...
        describe('negative decimal numbers on 10 characters', function () {
            it('-1111111.1', function () {
                currentNumber = -1111111.1;
                expectCorrectNumber('Error');
            });
    ...
    describe('display Correct Number', function () {

        describe('postive whole numbers', function () {
